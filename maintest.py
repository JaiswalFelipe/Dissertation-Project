...
def validate(validation_loader, net, epoch, output_path):
    ...
    with torch.no_grad():
        ...
        for i, data in enumerate(validation_loader):
            ...
            for j in range(0, prob_im.shape[1], validation_loader.dataset.crop_size):
              for k in range(0, prob_im.shape[2], validation_loader.dataset.crop_size):
                  ...
                  prob_im[:, cur_x:cur_x + validation_loader.dataset.crop_size,
                          cur_y:cur_y + validation_loader.dataset.crop_size, :] += soft_outs_p[:, :, :, :]
