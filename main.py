...
def main():
    ...
    parser.add_argument('--csv_file', type=str, required=False, help='CSV file for validation.')
    ...
    if args.operation == 'Train':
        ...
        validation_set = NGValid(args.csv_dir, args.csv_file, args.val_img_dir, args.val_mask_dir, args.output_path)
