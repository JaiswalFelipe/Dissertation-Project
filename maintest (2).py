...
Original file is located at
    https://colab.research.google.com/drive/1BkhHvc7H84zew4srhV9t9QyqGgWe7oXN
"""
...
def validate(validation_loader, net, epoch, output_path):
    ...
    print("prob_im shape", prob_im.shape)
    ...
    with torch.no_grad():
        ...
        for i, data in enumerate(validation_loader):
            ...
            print("inps index 0 shape", inps.shape[0])
